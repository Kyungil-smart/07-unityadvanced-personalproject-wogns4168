...
public class ShopPanel : MonoBehaviour
{
    ...
    [Header("버튼")] [SerializeField] private Button healButton;
    ...
    [Header("카드 삭제 패널")] [SerializeField] private GameObject removeCardPanel;
    [SerializeField] private Transform removeCardContainer;
    [SerializeField] private Button closeButton;

    [Header("에너지 증가")] [SerializeField] private Button energyButton;
    [SerializeField] private TMP_Text energyCostText;

    [Header("가격 설정")] [SerializeField] private int healCost = 50;
    ...
    [SerializeField] private int energyCost = 120;

    [Header("골드 표시 위치 오프셋")] [SerializeField]
    private Vector2 goldGroupOffset = new Vector2(50f, -80f);
    ...
    {
        if (RunManager.Instance.Gold < energyCost)
        {
            Debug.Log("골드 부족!");
            return;
        }

        RunManager.Instance.AddGold(-energyCost);
